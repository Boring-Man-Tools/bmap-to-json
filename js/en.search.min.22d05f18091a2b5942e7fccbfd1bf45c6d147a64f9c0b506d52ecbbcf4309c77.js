...
function init(){input.removeEventListener('focus',init);loadScript('/bmap-to-json/js/groupBy-700a0a22e5.min.js');loadScript('/bmap-to-json/js/flexsearch-e54a90f706.min.js',function(){const indexCfgDefaults={tokenize:'forward'}
const indexCfg=indexCfgDefaults;const dataUrl='/bmap-to-json/en.search-data.min.json'
